    ...
    return (
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="md:ml-56 p-4">
                ...
                {/* Task Table */}
                <div ref={tableRef} className="overflow-x-auto bg-white rounded shadow">
                        ...
                        <tbody>
                            {currentTasks.map((task) => (
                                <tr key={task.taskId} className="hover:bg-gray-50 transition">
                                    <td className="border p-2">{task.sprintNumber}</td>
                                    ...
                                    <td className="border p-2">{task.progress}</td>
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
                    <div className="bg-white p-6 rounded-lg w-full max-w-2xl relative">
                        ...
                        <TaskForm onSuccess={() => { setShowModal(false); fetchTasks(); }} />
                    </div>
                </div>
            )}
        </div>
